...
struct LocalSpeciesProfile: Identifiable, Codable, Hashable, Sendable {
    ...
    var species: Species {
        ...
        value.regionalOccurrenceNotes = regionalOccurrenceNotes; value.subregions = subregions
        value.aliases = aliases; value.categories = categories; value.colors = colors
        value.markings = markings; value.bodyShapes = bodyShapes; value.habitats = habitats
        value.regions = regions; value.behaviors = behaviors; value.keywords = keywords
