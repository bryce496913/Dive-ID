...
extension LocalSpeciesProfile {
    init(id: UUID, commonName: String, scientificName: String, aliases: [String], categories: [String], colors: [String], markings: [String], bodyShapes: [String], habitats: [String], regions: [String], behaviors: [String], keywords: [String], minimumSizeCentimeters: Double?, maximumSizeCentimeters: Double?, minimumDepthMeters: Double?, maximumDepthMeters: Double?, summary: String, distinguishingFeatures: [String], typicalHabitat: String, geographicRange: String, cautions: [String], imageAssetName: String?, regionalOccurrence: RegionalOccurrenceStatus = .regular, regionalOccurrenceNotes: String? = nil, subregions: [String] = [], appearanceVariants: [SpeciesAppearanceVariant] = [], similarSpecies: [SimilarSpeciesComparison] = [], bundledImage: BundledSpeciesImage? = nil, dataSources: [SpeciesDataSourceReference] = []) {
        self.id = id; self.commonName = commonName; self.scientificName = scientificName; self.aliases = aliases; self.categories = categories; self.colors = colors; self.markings = markings; self.bodyShapes = bodyShapes; self.habitats = habitats; self.regions = regions; self.behaviors = behaviors; self.keywords = keywords; self.minimumSizeCentimeters = minimumSizeCentimeters; self.maximumSizeCentimeters = maximumSizeCentimeters; self.minimumDepthMeters = minimumDepthMeters; self.maximumDepthMeters = maximumDepthMeters; self.summary = summary; self.distinguishingFeatures = distinguishingFeatures; self.typicalHabitat = typicalHabitat; self.geographicRange = geographicRange; self.cautions = cautions; self.imageAssetName = imageAssetName; self.regionalOccurrence = regionalOccurrence; self.regionalOccurrenceNotes = regionalOccurrenceNotes; self.subregions = subregions; self.appearanceVariants = appearanceVariants; self.similarSpecies = similarSpecies; self.bundledImage = bundledImage; self.dataSources = dataSources
    }
}
